        ...
        <Layout>
            {
                officerData.officer ?
                    <Container dir="rtl">
                        <br />
                        <Row >
                            <Col xs={"auto"}><Button variant="outlined" className="ButtonRow" color="primary" onClick={() => handlePrint()}> <AiFillPrinter /> طباعة نموذج تقيم اسبوعي عن الضابط</Button></Col>
                        </Row>
                        <br /><br />
                        <Row>
                            <Col xs={12}>
                                <Typography variant="h5"> بيانات الضابط</Typography></Col>
                        </Row>
                        <br />
                        <Row>
                        ...
                        <Row>
                            <Row className="ButtonRow">
                                <Col xs={12}><Button variant="contained" color="primary" onClick={() => handleCreate("attendance")} >إضافة حالة حضور الضابط</Button></Col>
                            </Row>
                            <br /> 
                             <Row className="ButtonRow">
                        ...
                        <Row>
                            <Col xs={12}>
                                <Typography variant="h5"> إحصائيات حضور الضابط للمواد</Typography>
                            </Col>
                        </Row>
                        <br/>
                        {
                            officerData.courses.map((course,i)=>{
                                return <Row>
                                    ...
                                    <ChartMe data={ officerData.coursesRating[i][0]} title={"المحاضرة"}/>
                                    <ChartMe data={officerData.coursesRating[i][1]} title={"التمارين"}/>
                                    <ChartMe data={   officerData.coursesRating[i][2]} title={"المعمل"}/>
                                </Row>
                            })
                        }
                        {/*<Row>
                        <ChartMe data={officerData.officertotalStatus} title={"المادة"}/>
                        <ChartMe data={officerData.LecStatus} title={"المحاضرة"}/>
                        <ChartMe data={officerData.SecStatus} title={"التمارين"}/>
                        <ChartMe data={officerData.LabStatus} title={"المعمل"}/>
                    </Row>*/}
