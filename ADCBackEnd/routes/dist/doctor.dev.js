...
router.post('/AttendanceAll', function _callee4(req, res) {
  var doctors, data, i, _date, docAttendance;
        ...
        case 6:
          ...
          return regeneratorRuntime.awrap(models.doctorAttendance.findAll({
            where: {
              ...
              date: (_date = {}, _defineProperty(_date, Op.gte, req.body.datatime.from), _defineProperty(_date, Op.lte, req.body.datatime.to), _date)
            },
            attributes: ['status', 'date', 'type'],
            order: [['date', 'ASC']],
            raw: true
          }));

        case 9:
          docAttendance = _context4.sent;
          data.push({
            name: doctors[i].name,
            attendance: docAttendance
          });
  ...
  return regeneratorRuntime.async(function _callee5$(_context5) {
    while (1) {
      switch (_context5.prev = _context5.next) {
        ...
        case 6:
          doctorAttendance = _context5.sent;
          _context5.next = 9;
...
router.put("/:id", function _callee10(req, res, next) {
  var doctors;
